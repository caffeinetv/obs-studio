REM TODO: Revert this when libcaffeine is included in obs dependencies
REM if exist dependencies2017.zip (curl -kLO https://cdn-fastly.obsproject.com/downloads/dependencies2017.zip -f --retry 5 -z dependencies2017.zip) else (curl -kLO https://cdn-fastly.obsproject.com/downloads/dependencies2017.zip -f --retry 5 -C -)
if exist dependencies2017.zip (curl -kLO https://static.caffeine.tv/broadcaster/dependencies2017.zip -f --retry 5 -z dependencies2017.zip) else (curl -kLO https://static.caffeine.tv/broadcaster/dependencies2017.zip -f --retry 5 -C -)
