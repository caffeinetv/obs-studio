...
bool OBSBasic::LoadService()
{
	...
	obs_data_set_default_string(data, "type", "caffeine_service");
...
bool OBSBasic::InitService()
{
	...
	service = obs_service_create("caffeine_service", "default_service", nullptr,
			nullptr);
	if (!service)
		return false;
	obs_service_release(service);
...
{
	if (!service) {
		service = obs_service_create("caffeine_service", NULL, NULL,
				nullptr);
		obs_service_release(service);
	}
	return service;
