...
#ifdef NDEBUG
#define LOG_SEVERITY caff_LogLevelWarning
#else
#define LOG_SEVERITY caff_LogLevelDebug
#endif
...
bool obs_module_load(void)
{
	...
	caff_Result result = caff_initialize(
		"obs", OBS_VERSION, LOG_SEVERITY, caffeine_log);
