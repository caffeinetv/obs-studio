...
:-build 
    ...
    cd build64
    cmake -G"Visual Studio 16 2019" -A"x64" -DCMAKE_SYSTEM_VERSION="10.0.18363.657" -DBUILD_BROWSER=true -DCOMPILE_D3D12_HOOK=true -DDepsPath="%DepsPath%" -DQTDIR="%QTDIR%" -DENABLE_VLC=ON -DVLCPath="%VLCPATH%" -DCEF_ROOT_DIR="%CEF_ROOT_DIR%" -DCOPIED_DEPENDENCIES=FALSE -DCOPY_DEPENDENCIES=TRUE  -DVIRTUALCAM_GUID="A3FCE0F5-3493-419F-958A-ABA1250EC20B" -DLIBCAFFEINE_DIR="%LIBCAFFEINE_DIR%" ..    
    cd ..
